(ns boatmfg.phase
  "Phase 0->3 staged rollout for the pleasure-and-sporting-boat-
  building plant-operations coordination actor.
  ...
  consequence (a hull-molding/rigging/final-assembly/water-test
  ...
  `boatmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Boat Building Plant Operations Governor verdict to a base
