# Business Model: Building of pleasure and sporting boats
...
## Classification
- Repository: `cloud-itonami-isic-3012` ([github.com/cloud-itonami/cloud-itonami-isic-3012](https://github.com/cloud-itonami/cloud-itonami-isic-3012))
- ISIC Rev.5: `3012` — Building of pleasure and sporting boats
- Domain: `:boat-building/manufacturing`
- Social impact: :worker-safety :occupant-safety :boater-safety
- Actor: `:boat-building-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :boat-building/manufacturing — who wants
...
One managed tenant (:boat-building/manufacturing):
...
- Do not bypass the `:boat-building-plant-operations-governor` for production decisions.
