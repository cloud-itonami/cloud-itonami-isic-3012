# Operator Quickstart — Building of pleasure and sporting boats

Shortest path from clone to a verified local dry-run for **ISIC 3012** (`cloud-itonami-isic-3012`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3012.git
cd cloud-itonami-isic-3012
```
...
- Blueprint governor key: `boat-building-plant-operations-governor`
- Likely source path: `boatmfg.governor.cljc`
